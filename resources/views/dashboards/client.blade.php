    ...
    <div class="container py-4">
        ...
        @if($lead)
            <div class="card mt-3 p-4">
                ...
                <p class="card-text"><strong>Package Deal:</strong> {{ $lead->package_deal ? 'Yes' : 'No' }}</p>
                ...
                <a href="{{ route('client.combined_leads.show', $lead->id) }}" class="btn btn-outline-secondary mt-3">View
                    Details</a>
            </div>
        @else
