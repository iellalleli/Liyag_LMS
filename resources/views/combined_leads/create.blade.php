        ...
        <form method="POST" action="{{ route('combined_leads.store') }}">
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="date" name="target_wedding_date" class="form-control"
                        value="{{ old('target_wedding_date') }}" required>
                </div>
                <div class="col-md-6">
            ...
            <div class="mb-3">
                ...
                <select name="budget_range" class="form-control" required>
                    ...
                    <option value="under_50k" {{ old('budget_range') == 'under_50k' ? 'selected' : '' }}>
                        Under ₱50,000
                    </option>
                    <option value="50k_100k" {{ old('budget_range') == '50k_100k' ? 'selected' : '' }}>
                        ₱50,000 - ₱100,000
                    </option>
                    <option value="100k_200k" {{ old('budget_range') == '100k_200k' ? 'selected' : '' }}>
                        ₱100,000 - ₱200,000
                    </option>
                    <option value="200k_plus" {{ old('budget_range') == '200k_plus' ? 'selected' : '' }}>
                        Above ₱200,000
                    </option>
                </select>
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="number" name="guest_count" class="form-control" value="{{ old('guest_count') }}" min="0"
                    required>
            </div>
            ...
            <div class="mb-3">
                ...
                <label><input type="checkbox" name="package_deal" value="1" {{ old('package_deal') ? 'checked' : '' }}>
                    Package Deal</label><br>
                <label><input type="checkbox" name="catering" value="1" {{ old('catering') ? 'checked' : '' }}>
                    Catering</label><br>
                <label><input type="checkbox" name="hair_makeup" value="1" {{ old('hair_makeup') ? 'checked' : '' }}> Hair &
                    Makeup</label><br>
                <label><input type="checkbox" name="live_band" value="1" {{ old('live_band') ? 'checked' : '' }}> Live
                    Band</label>
            </div>
