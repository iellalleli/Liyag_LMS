...
@section('content')
            ...
            <div class="center-message animate-fade">
                ...
                <p class="mt-4" style="font-size: 1rem; color: #4b2e2e;">
                    ...
                    <a href="https://drive.google.com/file/d/1rI8g42u4WK9QODJzXtzPETIUpSFmunJg/view?usp=sharing"
                        target="_blank" style="color:#a46a4e; font-weight: 600; text-decoration: underline;">Terms &
                        Conditions</a>
                    and
                    <a href="https://drive.google.com/file/d/1LHLeR3ud4Gj9XAZqE4KKNc2WzsVaz34V/view?usp=sharing"
                        target="_blank" style="color:#a46a4e; font-weight: 600; text-decoration: underline;">Privacy
                        Policy</a>.
                </p>
            </div>
        </div>
        ...
        <div class="features-box">
            ...
            <div class="feature-row">
                ...
                <div class="feature-item">
                    ...
                    <p class="feature-desc">Track your assigned leads, manage daily tasks, and engage with potential
                        clients.</p>
                </div>
                <div class="feature-item">
                    <div class="icon-circle">💌</div>
                    <h6 class="feature-title">Client Access</h6>
                    <p class="feature-desc">Request personalized wedding quotations and easily send event inquiries online.
                    </p>
                </div>
            </div>
        </div>
    ...
    <section class="testimonials-section" id="testimonials">
        <div class="testimonials-container">
            <h4 class="testimonials-heading">
                Aside from vowing ‘I do’, the couples say they love us too! <br><span style="font-weight: 400;">(and we love
                    them)</span>
            </h4>
            ...
            <div class="testimonial-item">
                ...
                <div class="testimonial-quote">
                    <p>“We were able to plan our dream wedding effortlessly thanks to this amazing site! Babait ng mga Sales
                        Rep. 😍”</p>
            ...
            <div class="testimonial-item">
                <div class="testimonial-quote">
                    <p>“I love the process, bilis lang! Nagustuhan namin yung style ng wedding. Baka magpakasal kami ulit –
                        hangkuleet?!”</p>
                    <span class="testimonial-name">Claudia & Sebastian</span>
                </div>
                <img src="{{ asset('images/avatars/claudia.png') }}" alt="Claudia & Sebastian"
                    class="testimonial-avatar right">
            </div>
    ...
    <section class="real-wedding-section" id="weddings">
        <div class="container">
            ...
            <div id="weddingCarousel" class="carousel slide mx-auto" data-bs-ride="carousel" data-bs-interval="3000"
                style="max-width: 960px;">
                <div class="carousel-inner">
                    <!-- Slide 1 -->
                    <div class="carousel-item active">
                        <img src="{{ asset('images/weddings/couple1.jpg') }}" class="d-block w-100" alt="Marco & Lea"
                            style="height:450px; object-fit:cover; border-radius:18px;">
                    ...
                    <div class="carousel-item">
                        <img src="{{ asset('images/weddings/couple2.jpg') }}" class="d-block w-100" alt="Jenna & Luis"
                            style="height:450px; object-fit:cover; border-radius:18px;">
                        <div class="carousel-caption">
                    ...
                    <!-- Slide 3 -->
                    <div class="carousel-item">
                        <img src="{{ asset('images/weddings/couple3.jpg') }}" class="d-block w-100" alt="Trixie & Paulo"
                            style="height:450px; object-fit:cover; border-radius:18px;">
                        <div class="carousel-caption">
                            <h5>Criza & Onie</h5>
                ...
                <div class="carousel-indicators mt-4">
                    <button type="button" data-bs-target="#weddingCarousel" data-bs-slide-to="0" class="active"
                        aria-current="true" aria-label="Slide 1"></button>
                    <button type="button" data-bs-target="#weddingCarousel" data-bs-slide-to="1"
                        aria-label="Slide 2"></button>
                    <button type="button" data-bs-target="#weddingCarousel" data-bs-slide-to="2"
    ...
    <section class="about-section" id="about">
        <div class="container">
            ...
            <p class="about-subheading">
                We are Group 7 from BSCS 3-2’s Web Development class — a passionate team of developers and creatives working
                together to make wedding planning seamless, stylish, and uniquely you. 💍✨
            </p>
