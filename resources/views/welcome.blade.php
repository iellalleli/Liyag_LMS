        ...
        <div class="auth-buttons mt-4">
            @auth
                ...
                @elseif(auth()->user()->hasRole('sales_rep'))
                    <a href="{{ route('sales.dashboard') }}" class="btn btn-soft">Go to Dashboard</a>
                @elseif(auth()->user()->hasRole('client'))
                    <a href="{{ route('client.dashboard') }}" class="btn btn-soft">Get Quotation</a>
                @endif
            @else
                <a href="{{ route('login') }}" class="btn btn-soft">Login</a>
                <a href="{{ route('register') }}" class="btn btn-soft">Register as Client</a>
            @endauth
        </div>
